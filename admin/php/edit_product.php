<?php 
   ...
   if (isset($_POST['edit_product'] ) ) {
    ...
    if(isset($_FILES['p_image']) && $_FILES['p_image']['size'] > 0) {
        ...
        // If no new image is uploaded, retain the previous image
        $sql_select_img = "SELECT p_image FROM pent_tbl WHERE p_id=?";
        $stmt_select_img = $conn->prepare($sql_select_img);
        $stmt_select_img->bind_param("i", $p_id);
        $stmt_select_img->execute();
        $stmt_select_img->bind_result($p_img);
    ...
    if(isset($_FILES['p_image']) && $_FILES['p_image']['size'] > 0) {
        ...
        // If no new image is uploaded, retain the previous image
        $sql_select_img = "SELECT p_image FROM shoes_tbl WHERE p_id=?";
        $stmt_select_img = $conn->prepare($sql_select_img);
        $stmt_select_img->bind_param("i", $p_id);
        $stmt_select_img->execute();
        $stmt_select_img->bind_result($p_img);
    ...
    //     move_uploaded_file($p_img_tmp, "../assets/img/product/" . $p_img);
    // } else {
    //     // If no new image is uploaded, retrieve and keep the previous image
    //     $sql_select_img = "SELECT p_image FROM shirt_tbl WHERE p_id=?";
    //     $stmt_select_img = $conn->prepare($sql_select_img);
    //     $stmt_select_img->bind_param("i", $p_id);
    //     $stmt_select_img->execute();
    //     $stmt_select_img->bind_result($prev_p_img);
    //     $stmt_select_img->fetch();
    //     $stmt_select_img->close();
    // }
    
    if(isset($_FILES['t_img1']) && $_FILES['t_img1']['size'] > 0) {
        $t_img2 = $_FILES['t_img1']['name'];
        $t_img2_tmp = $_FILES['t_img1']['tmp_name'];
    ...
    if(isset($_FILES['t_img1']) && $_FILES['t_img1']['size'] > 0) {
        ...
        // If no new image is uploaded, retain the previous image
        $sql_select_img = "SELECT p_img2 FROM pent_tbl WHERE p_id=?";
        $stmt_select_img = $conn->prepare($sql_select_img);
        $stmt_select_img->bind_param("i", $p_id);
        $stmt_select_img->execute();
        $stmt_select_img->bind_result($t_img2);
    ...
    if(isset($_FILES['t_img1']) && $_FILES['t_img1']['size'] > 0) {
        ...
        // If no new image is uploaded, retain the previous image
        $sql_select_img = "SELECT p_img2 FROM shoes_tbl WHERE p_id=?";
        $stmt_select_img = $conn->prepare($sql_select_img);
        $stmt_select_img->bind_param("i", $p_id);
        $stmt_select_img->execute();
        $stmt_select_img->bind_result($t_img2);
    ...
    if(isset($_FILES['t_img3']) && $_FILES['t_img3']['size'] > 0) {
        ...
        // If no new image is uploaded, retain the previous image
        $sql_select_img = "SELECT p_img3 FROM pent_tbl WHERE p_id=?";
        $stmt_select_img = $conn->prepare($sql_select_img);
        $stmt_select_img->bind_param("i", $p_id);
        $stmt_select_img->execute();
        $stmt_select_img->bind_result($t_img3);
    ...
    if(isset($_FILES['t_img3']) && $_FILES['t_img3']['size'] > 0) {
        ...
        // If no new image is uploaded, retain the previous image
        $sql_select_img = "SELECT p_img3 FROM shoes_tbl WHERE p_id=?";
        $stmt_select_img = $conn->prepare($sql_select_img);
        $stmt_select_img->bind_param("i", $p_id);
        $stmt_select_img->execute();
        $stmt_select_img->bind_result($t_img3);
    ...
    if(isset($_FILES['t_img4']) && $_FILES['t_img4']['size'] > 0) {
        ...
        // If no new image is uploaded, retain the previous image
        $sql_select_img = "SELECT p_img4 FROM pent_tbl WHERE p_id=?";
        $stmt_select_img = $conn->prepare($sql_select_img);
        $stmt_select_img->bind_param("i", $p_id);
        $stmt_select_img->execute();
        $stmt_select_img->bind_result($t_img4);
    ...
    if(isset($_FILES['t_img4']) && $_FILES['t_img4']['size'] > 0) {
        ...
        // If no new image is uploaded, retain the previous image
        $sql_select_img = "SELECT p_img4 FROM shoes_tbl WHERE p_id=?";
        $stmt_select_img = $conn->prepare($sql_select_img);
        $stmt_select_img->bind_param("i", $p_id);
        $stmt_select_img->execute();
        $stmt_select_img->bind_result($t_img4);
    ...
    if(isset($_FILES['t_img4']) && $_FILES['t_img4']['size'] > 0) {
       ...
       if($p_category == "shirt")
       {
        ...
        $sql = "UPDATE `pent_tbl` SET `p_image` = '$p_img',`p_img1` = '$t_img1',`p_img2` = '$t_img2' ,`p_img3` = '$t_img3', `p_name` = '$p_name', `p_mrp` = '$p_mrp', `p_final_price` = '$p_final_price', `p_stock` = '$p_stock', `p_material_type` = '$p_material_type', `p_length` = '$p_length', `p_style` = '$p_style', `p_closure_type` = '$p_closure_type', `p_description1` = '$long_description', `p_description2` = '$short_description' WHERE `pent_tbl`.`p_id` = '$p_id' ";
        $result = mysqli_query($conn, $sql);
    ...
    $sql = "UPDATE `shoes_tbl` SET `p_image` = '$p_img', `p_img1` = '$t_img1',`p_img2` = '$t_img2' ,`p_img3` = '$t_img3', `p_name` = '$p_name', `p_mrp` = '$p_mrp', `p_final_price` = '$p_final_price', `p_stock` = '$p_stock', `s_material_type` = '$s_material_type', `s_closure_type` = '$s_closure_type', `s_heel_type` = '$s_heel_type', `s_w_r_l` = '$s_w_r_l', `s_sole_material` = '$s_sole_material', `s_style` = '$s_style', `p_description1` = '$long_description', `p_description2` = '$short_description' WHERE `shoes_tbl`.`p_id` = '$p_id' ";
    $result = mysqli_query($conn, $sql);
